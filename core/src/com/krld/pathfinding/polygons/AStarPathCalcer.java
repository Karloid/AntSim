...
public class AStarPathCalcer implements PathCalcer {
    ...
    private Node findNodeByPosition(com.krld.pathfinding.ants.model.Point point) {
    ...
    private com.krld.pathfinding.ants.model.Point pickGoalPosition() {
        return new com.krld.pathfinding.ants.model.Point(10, 10);
    }

    private double getManhattanDistance(com.krld.pathfinding.ants.model.Point position, com.krld.pathfinding.ants.model.Point position1) {
